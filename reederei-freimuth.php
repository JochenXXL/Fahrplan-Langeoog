...
?>
  ...
  <div class="col col-lg-8 col-lg-pull-4">
    ...
    <div class="alert alert-danger" role="alert">
      <strong>Achtung!</strong> Da die Anzahl der Fahrgäste begrenzt ist und die Fahrten erst ab 5 Personen durchgeführt werden, wird um eine frühzeitige Reservierung unter <strong>0151/23788565</strong> gebeten.
    </div>
    <p>Bitte beachten Sie, dass kein direkter Anschluss zur Inselbahn besteht. Ihr Gepäck können Sie mit DHL oder anderen Paketdienstleistern bis zur Unterkunft auf Langeoog liefern lassen. Vom Hafen gelangen zu Fuß oder per mitgebrachtem Rad in den Ort.</p>

    <h4>Preise</h4>
      <p>Für <strong>18,00 € pro Person</strong> bringt die Reederei Freimuth Sie und ein Gepäckstück von Bensersiel zum Hafen Langeoog oder vom Hafen Langeoog nach Bensersiel.<br>
      Für 8,00 € können Sie Ihr Fahrrad mit an Bord nehmen.<br>
      Pro Familie geht <strong>ein Hund gratis</strong> mit auf die Reise. Jeder weitere Hund bezahlt 8,00 €.<br>
      Für Vielfahrer gibt es eine 11er Karte für 180,00 €.</p>
    <h3 class="p-t-2">Charter</h3>
    <p>
    ...
    <dl class="row">
      ...
      <dd class="col-sm-9">0151 23788565</dd>
